...
public class LoggerAspect {
	...
	@Around("execution(* com.ytech.services.*.*(..))")
	...
	@Around("@annotation(com.ytech.interfaces.LogAspect)")
	...
	@AfterThrowing(value = "execution(* com.ytech.services.*.*(..))", throwing = "ex")
	...
	@AfterReturning(value = "execution(* com.ytech.services.*.*(..))", returning = "retVal")
